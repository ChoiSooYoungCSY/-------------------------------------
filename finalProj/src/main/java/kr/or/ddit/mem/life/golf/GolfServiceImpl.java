...
public class GolfServiceImpl implements GolfService {
	...
	// 좌석 번호
	@Override
	public List<PuttingRoomInfoVO> selectRoom(){
		return puttingRoomInfoMapper.selectRoom();
	}

	// 골프장 예약 가능한 자리
	@Override
	public List<PuttingRoomInfoVO> useRoom(){
		return puttingRoomInfoMapper.useRoom();
	}
